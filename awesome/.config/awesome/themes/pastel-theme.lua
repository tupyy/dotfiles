...
-- Font
theme.font = "JetBrains Mono Nerd Font Regular 16"
theme.title_font = "JetBrains Mono Nerd Font Regular 16"
...
theme.top_panel_height = dpi(45)
theme.top_panel_height2 = dpi(35)

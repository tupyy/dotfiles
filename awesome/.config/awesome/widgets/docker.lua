...
local WIDGET_DIR = HOME_DIR .. '/.config/awesome'
local ICONS_DIR = WIDGET_DIR .. '/icons/docker/'

local LIST_CONTAINERS_CMD = [[bash -c "podman container ls -a -s -n %s]]
            ...
            if container.is_up() or container.is_exited() then
                ...
                start_stop_button:buttons(
                    gears.table.join(awful.button({}, 1, function()
                        ...
                        spawn.easy_async('podman ' .. command .. ' ' .. container['name'], function()
            ...
            if container.is_up() then
                ...
                pause_unpause_button:buttons(
                    gears.table.join(awful.button({}, 1, function()
                        ...
                        awful.spawn.easy_async('podman ' .. command .. ' ' .. container['name'], function(_, stderr)

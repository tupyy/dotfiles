...
local function worker(user_args)
    ...
    local pause_icon = args.pause_icon or os.getenv("HOME") .. '/.config/awesome/icons/spotify-player/pause.png'
    local font = args.font or 'JetBrains Mono Nerd Font Regular 8'
